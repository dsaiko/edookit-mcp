...
- **Args**: žádné
- **Env vars**: `EDOOKIT_URL`, `EDOOKIT_USER`, `EDOOKIT_PASS` (a volitelně `EDOOKIT_TIMEZONE`, `EDOOKIT_COOKIE_CACHE`, `EDOOKIT_NO_COOKIE_CACHE`, `EDOOKIT_HEADLESS_LOGIN`, `EDOOKIT_ALLOW_INSECURE_HTTP`, `EDOOKIT_HTTP_ADDR` — viz [.env.example](.env.example))

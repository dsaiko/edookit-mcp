...
Po napojení by se v konverzaci měly objevit nástroje `edookit_list_inbox`, `edookit_list_sent`, `edookit_get_message`, `edookit_download_attachments`, `edookit_view_attachment` a `edookit_server_info`.

### Co umí (dostupné nástroje)

K dispozici je šest nástrojů:
